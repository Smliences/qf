...
<div class="main">
	...
	<form id="form1" name="form1" method="post" action="${pageContext.request.contextPath }/AddUserServlet" onsubmit="return checkit();">
<input type="hidden" name="flag" value="doAdd">
    ...
    <option value="1">男</option>
				...
				<tr>
					...
					<td><input type="radio" name="job" id="auth" value="0" checked="checked"/>普通用户
					<input type="radio" name="job" id="auth" value="1" />经理</td>
				</tr>
			</table>
		</div>
		<div class="buttons">
