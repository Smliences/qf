...
<table class="list">
  ...
  <c:forEach items="${providerList }" var="provider">
  	 <td width="70" height="29"><div class="STYLE1" align="center">${provider.pid }</div></td>
    <td width="80"><div class="STYLE1" align="center">${provider.pname }</div></td>
    <td width="100"><div class="STYLE1" align="center">${provider.pdesc }</div></td>
    <td width="100"><div class="STYLE1" align="center">${provider.plinkman }</div></td>
    <td width="100"><div class="STYLE1" align="center">${provider.pphone }</div></td>
    <td width="100"><div class="STYLE1" align="center">${provider.paddress }</div></td>
  </c:forEach>
</tbody></table>
	</div>
</div>
